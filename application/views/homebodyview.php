...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/jquery.simplyscroll.css">
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/jquery.simplyscroll.js"></script> 
<script type="text/javascript">
(function($) {
	$(function() {
...
<script type="text/javascript">
	if($("#scroller").length>0){
		$.post(url+"home/getnews",function(data){
			
			$("#scroller").html(data.view);
			$("#scroller").simplyScroll({orientation:'vertical',customClass:'vert'});
		},"json");
	}
</script>
