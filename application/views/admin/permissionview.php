...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Error 550</title>
...
<body>	
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-4 not-found text-center">
				   <div class="content">
					  <h3>Oops! <span class="error_meta">550 Permission Denied... </span></h3>
					  <p><span class="error_message"><span>We are sorry</span> You don't have permission to view the page :(</span></p>
					  <div class="btn-group">
						<a href="javascript:history.go(-1);" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Go Back</a>
	...
	<!-- SLIMSCROLL -->
	<script type="text/javascript" src="<?php echo base_url()?>data/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.min.js"></script>		    <script type="text/javascript" src="<?php echo base_url()?>data/js/jQuery-slimScroll-1.3.0/slimScrollHorizontal.min.js"></script>
	<!-- CUSTOM SCRIPT -->
