...
class admin{
	...
	function sendmail($from,$fromtxt,$to,$cc,$sub,$txt){		
		...
		$sett=$this->CI->cstonehomemodel->getsettings(1);
...
//		
	...
	function sendmailattach($from,$fromtxt,$to,$cc,$sub,$txt,$resume){		
...
//		
	...
	function sendmailforgotpwd($from,$fromtxt,$to,$cc,$sub,$txt){		
		
		$sett=$this->CI->centaadminmodel->getsettings(1);
...
//		
	...
	function sendmailattachments($from,$fromtxt,$to,$sub,$txt,$resume){
